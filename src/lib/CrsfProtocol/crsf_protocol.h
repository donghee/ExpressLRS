...
typedef struct rcPacketEncrypted_s
{
    crsf_header_t header;
    crsf_channels_encrypted_s channels;
} PACKED rcPacketEncrypted_t;
...
union inBuffer_U
{
    ...
    rcPacketEncrypted_t asRCPacketEncrypted_t; // access the memory as RC encrypted data
};
